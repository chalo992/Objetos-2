...
import ar.edu.unlp.info.oo2.objetos2.Ejer4Topografias.Agua;
import ar.edu.unlp.info.oo2.objetos2.Ejer4Topografias.Mixta;
import ar.edu.unlp.info.oo2.objetos2.Ejer4Topografias.Pantano;
import ar.edu.unlp.info.oo2.objetos2.Ejer4Topografias.Tierra;
...
public class TopografiaTest {
	...
	private Mixta mixta3;
	    ...
	    public void testIgualdadTopografia() {  	
	    	assertTrue(this.agua1.equals(agua2));
	    	assertTrue(this.tierra1.equals(tierra2));
	    	assertFalse(this.agua1.equals(tierra1));
	    	assertFalse(this.pantano1.equals(tierra2));
	    	assertTrue(this.pantano2.equals(pantano1));
	    	assertFalse(this.tierra1.equals(mixta1));
	    	assertTrue(this.mixta1.equals(mixta3));
	    	assertFalse(this.mixta3.equals(mixta2));
	    }
}
