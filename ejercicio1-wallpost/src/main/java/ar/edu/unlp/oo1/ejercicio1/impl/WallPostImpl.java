...
public class WallPostImpl implements WallPost {
	...
	public WallPostImpl() {
		...
		this.logger = Logger.getLogger(WallPostImpl.class.getName());
	}
	...
	public void like() {
        ...
        if (this.likes == 10) {
        	this.logger.log(Level.WARNING, "Se llegó a 10 likes");
        }
	}
	...
	public void dislike() {
		if (likes > 0) {
		 ...
		 if (this.likes == 0) {
			 this.logger.log(Level.WARNING, "Se llegó a 0 likes");
	        }
	}
