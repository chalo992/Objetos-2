...
public class WallPostUI {
  ...
  private Logger logger = Logger.getLogger(WallPostUI.class.getName());;
  ...
  public WallPostUI() {
    ...
    this.logger.log(Level.INFO, "Aplicacion iniciada");
  }
  ...
  private void wireComponents() {
    this.like.addActionListener( e -> {
      ...
      this.logger.log(Level.INFO, "Click Like");
    });
    
    this.dislike.addActionListener( e -> {
      this.wallPost.dislike();
      this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
      this.logger.log(Level.INFO, "Click DisLike");
    });
    ...
    this.textArea.getDocument().addDocumentListener(new DocumentListener() {
      ...
      public void removeUpdate(DocumentEvent e) {
        ...
        logger.log(Level.INFO, "Post modificado");
      }
